...
// ==================================================
// Auto logout เมื่อไม่มีการใช้งาน (idle) เกิน 30 นาที
// ==================================================
const IDLE_LOGOUT_MS = 30 * 60 * 1000;          // ไม่มีการใช้งาน 30 นาที -> เด้งออกจากระบบ
const IDLE_WARNING_BEFORE_MS = 2 * 60 * 1000;   // เตือนล่วงหน้า 2 นาทีก่อนออกจากระบบจริง
...
function resetIdleTimer() {
  ...
  idleWarningTimer = setTimeout(() => {
    showToast('ไม่มีการใช้งานนาน — ระบบจะออกจากระบบอัตโนมัติใน 2 นาที', 'error');
  }, IDLE_LOGOUT_MS - IDLE_WARNING_BEFORE_MS);

  idleLogoutTimer = setTimeout(async () => {
    await onLogout();
    showToast('ออกจากระบบอัตโนมัติ เนื่องจากไม่มีการใช้งานเกิน 30 นาที', 'default');
  }, IDLE_LOGOUT_MS);
}
